...
public interface UserRepo extends CrudRepository<User, Long>{
	...
	@Query(value="SELECT COUNT(distinct replies.id) as number_of_replies, COUNT(distinct likes.id), tweets.id as tweetId, tweets.text, tweets.created_at, users.id as userId, users.first_name, users.last_name, users.username, users.user_photo_path, tweets.photo_path, tweets.video_path FROM tweets"
